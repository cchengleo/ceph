...
class ObjectCacher {
 ...
 private:
  ...
  // io
  void bh_read(BufferHead *bh, bool op_compression);
  ...
  int _readx(OSDRead *rd, ObjectSet *oset, Context *onfinish,
	     bool external_call, bool op_compression = false);
 ...
 public:
   ...
   */
  int readx(OSDRead *rd, ObjectSet *oset, Context *onfinish, bool op_compression = false);
